...
| [**Realtime Dashboard**](https://github.com/cmkap/realtime-dashboard/tree/main)| A real-time dashboard application with a TypeScript Node.js backend and React frontend, featuring WebSocket updates, live deployment, and modular architecture.  | Node.js, Express, WebSocket, React, Vite, TypeScript, Render (frontend & backend auto-sleep), with live updates requiring both services to run concurrently.  [**Backend Link**](https://realtime-backend-q1uf.onrender.com/) [**Frontend Link**](https://realtime-frontend-boop.onrender.com/)|
