...
| ---------------------------- | ----------------- | ----------------- |
| [**Game Hub**](https://github.com/cmkap/game-hub)| Game Hub is a responsive web application designed to help you filter and search for games | Vite, Chakra UI, React, Axios, TypeScript and Framer Motion. [**Link**](https://game-hub-cmkap.vercel.app/)|
| [**TeamFlow Lite**](https://github.com/cmkap/teamflow-lite)| TeamFlow Lite is a lightweight full-stack demo app built with Next.js and TypeScript that simulates analysing team communication patterns to generate real-time insights and nudges.  | Next.js, Sentiment, Zod, Tailwind, React, Recharts, TypeScript and Vitest.  [**Link**](https://teamflow-lite.vercel.app/)|
| [**Realtime Dashboard**](https://github.com/cmkap/realtime-dashboard/tree/main)| A real-time dashboard application with a TypeScript Node.js backend and React frontend, featuring WebSocket updates, live deployment, and modular architecture.  | Tech/Tools: Node.js, Express, WebSocket, React, Vite, TypeScript, Render (frontend & backend auto-sleep), with live updates requiring both services to run concurrently.  [**Backend Link**](https://realtime-backend-q1uf.onrender.com/) [**Frontend Link**](https://realtime-frontend-boop.onrender.com/)|
| [**Movie API**](https://github.com/cmkap/movie-api) | Movie API is a backend service for an imaginary movie rental application, featuring authentication, validation, and secure data handling. | Node.js, Express.js, MongoDB (Mongoose), JWT, Joi, bcrypt, dotenv, Helmet, Winston (logging), Jest & Supertest (testing) |
...
| [**Makers BnB**](https://github.com/cmkap/makers-bnb)| Airbnb-inspired web application | Ruby, HTML, CSS, JavaScript, Rspec, Capybara, PostgreSQL, Sinatra
